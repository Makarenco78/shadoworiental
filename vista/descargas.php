...
<script>
	document.body.style.backgroundImage = "url('../images/bg-images/background3.jpg')";
</script>
...
<div class="articulo fondo">
	<p class="parrafo claro sm">[1] Registra <a class="enlace" href="../vista/registro.php">aquí</a> tu cuenta para entrar a Wow Shadowlands.<br>
	<b class="importante">Importante</b> El correo electrónico será el nombre de tu cuenta y el password la contraseña.<br><br>
	[2] Descarga el mini-cliente Wow Shadowland. Es un archivo comprimido de 4 Gb, llamado "Client Shadow.rar". Tenes dos opciones de descarga:</p>
	<div id="caja">
